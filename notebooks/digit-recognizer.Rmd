...
In collaboration with the Optimistic Data Spirit, this is my process in R to solve the Digit Recognizer Project Kaggle competition and hence to learn computer vision fundamentals. For all details about this competition see <https://www.kaggle.com/c/digit-recognizer/data>.
...
```{r train}
history <- network %>%
  fit(train_data, train_labels, epochs = 25, batch_size = 128)
```
